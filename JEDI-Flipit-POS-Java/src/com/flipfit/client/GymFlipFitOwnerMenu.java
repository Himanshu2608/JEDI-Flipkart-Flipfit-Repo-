...
public class GymFlipFitOwnerMenu {
    ...
    public static void getFlipFitOwnerView(FlipFitUser gymOwner) throws InvalidChoiceException {
        try {
            ...
            FlipFitGymCentreBusiness GCBservice = new FlipFitGymCentreBusiness(gymCentreDAO);
    ...
    //                        }
                        ...
                        case 3: {
                            ...
                            if (!GCBservice.isGymCentreAvailable(centreId)) {
                ...
                } catch (GymCentreNotFoundException | InvalidChoiceException e) {
